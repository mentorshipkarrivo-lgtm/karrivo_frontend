...
//     const [bookingData, setBookingData] = useState({ checkIn: '', checkOut: '', guests: 1, name: '', email: '', phone: '' });
...
//     const handleBookClick = () => setShowBookingForm(true);
...
//                 <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=1920&h=1080&fit=crop)' }} />
//                 <div className="absolute inset-0 bg-black/60" />
//                 <div className="relative z-10 text-center text-white px-6">
//                     <h1 className="text-4xl md:text-5xl font-bold mb-3">Connect with Top Mentors</h1>
//                     <p className="text-gray-300 mb-4">Browse mentors and book sessions to accelerate your career.</p>
//                 </div>
//             </div>
...
//                         {mentors.map((mentor) => (
//                             <div key={mentor._id} className="group bg-white rounded-2xl overflow-hidden shadow hover:shadow-2xl cursor-pointer transition-all" onClick={() => handleViewDetails(mentor)}>
//                                 <div className="relative h-60 overflow-hidden">
//                                     <img src={mentor.profileImage || '/default-avatar.png'} alt={mentor.fullName} className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition duration-500" />
//                                     <div className="absolute bottom-4 right-4 w-10 h-10 rounded-full flex items-center justify-center bg-[#0098cc] shadow-lg">
//                                         <Award className="w-5 h-5 text-white" />
//                                     </div>
//                                 </div>
//                                 <div className="p-4">
//                                     <h3 className="text-lg font-bold text-[#062117]">{mentor.fullName}</h3>
//                                     <p className="text-[#062117]/70 text-sm">{mentor.currentRole}</p>
//                                 </div>
//                             </div>
//                         ))}
//                     </div>
...
//                     <div className="bg-white rounded-xl max-w-4xl w-full mx-4 md:mx-0 overflow-y-auto max-h-[90vh] relative p-6">
//                         <button className="absolute top-4 right-4 text-gray-700" onClick={() => setSelectedMentor(null)}>
//                             <X size={24} />
//                         </button>
...
//                                     <h2 className="text-2xl font-bold text-[#062117] mb-2">{selectedMentor.fullName}</h2>
//                                     <p className="text-gray-600"><strong>Email:</strong> {selectedMentor.email}</p>
//                                     <p className="text-gray-600"><strong>Phone:</strong> {selectedMentor.phone}</p>
//                                     <p className="text-gray-600"><strong>Location:</strong> {selectedMentor.location}</p>
//                                     <p className="text-gray-600"><strong>Current Role:</strong> {selectedMentor.currentRole}</p>
//                                     <p className="text-gray-600"><strong>Company:</strong> {selectedMentor.companyName}</p>
//                                     <p className="text-gray-600"><strong>Experience:</strong> {selectedMentor.yearsOfExperience} yrs</p>
//                                     <p className="text-gray-600"><strong>Category:</strong> {selectedMentor.mentorCategory}</p>
//                                     <p className="text-gray-600"><strong>Mentoring Style:</strong> {selectedMentor.mentoringStyle}</p>
//                                     <p className="text-gray-600"><strong>Frequency:</strong> {selectedMentor.mentoringFrequency}</p>
//                                     <p className="text-gray-600"><strong>Languages:</strong> {selectedMentor.languages.join(', ')}</p>
//                                     <p className="text-gray-600"><strong>Hourly Rate:</strong> ₹{selectedMentor.hourlyRate}</p>
//                                     <p className="text-gray-600"><strong>LinkedIn:</strong> <a href={selectedMentor.linkedinUrl} target="_blank" className="text-[#0098cc] underline">{selectedMentor.linkedinUrl}</a></p>
//                                     <p className="text-gray-600"><strong>Areas of Interest:</strong> {selectedMentor.areasOfInterest}</p>
//                                 </div>

//                                 {/* Right: Actions */}
//                                 <div className="flex flex-col gap-4">
//                                     <button onClick={handleBookClick} className="bg-[#0098cc] hover:bg-[#007fa3] text-white font-semibold py-2 rounded-lg transition">Book Session</button>
//                                 </div>
//                             </div>
//                         ) : (
//                             // Booking Form
...
//                                     <h2 className="text-2xl font-bold text-[#062117]">Booking Details</h2>
//                                     <label className="block">
//                                         Check-in
//                                         <input type="date" name="checkIn" value={bookingData.checkIn} onChange={handleBookingChange} className="w-full border border-gray-300 rounded px-3 py-2 mt-1" required />
//                                     </label>
//                                     <label className="block">
//                                         Check-out
//                                         <input type="date" name="checkOut" value={bookingData.checkOut} onChange={handleBookingChange} className="w-full border border-gray-300 rounded px-3 py-2 mt-1" required />
//                                     </label>
//                                     <label className="block">
//                                         No. of Guests
//                                         <input type="number" min="1" name="guests" value={bookingData.guests} onChange={handleBookingChange} className="w-full border border-gray-300 rounded px-3 py-2 mt-1" required />
//                                     </label>
//                                 </div>

//                                 <div className="space-y-4">
//                                     <h2 className="text-2xl font-bold text-[#062117]">Contact Details</h2>
//                                     <label className="block">
//                                         Full Name
//                                         <input type="text" name="name" value={bookingData.name} onChange={handleBookingChange} className="w-full border border-gray-300 rounded px-3 py-2 mt-1" required />
//                                     </label>
//                                     <label className="block">
//                                         Email
//                                         <input type="email" name="email" value={bookingData.email} onChange={handleBookingChange} className="w-full border border-gray-300 rounded px-3 py-2 mt-1" required />
//                                     </label>
//                                     <label className="block">
//                                         Phone Number
//                                         <input type="text" name="phone" value={bookingData.phone} onChange={handleBookingChange} className="w-full border border-gray-300 rounded px-3 py-2 mt-1" required />
//                                     </label>

//                                     <button type="submit" className="bg-[#0098cc] hover:bg-[#007fa3] text-white font-semibold py-2 rounded-lg w-full transition">Book Now</button>
//                                 </div>
//                             </form>
//                         )}
//                     </div>
...
//                     <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
//                         {mentors.map((mentor) => (
//                             <div key={mentor._id} className="group bg-white rounded-2xl overflow-hidden shadow hover:shadow-2xl transition-all">
//                                 <div className="relative h-60 overflow-hidden">
//                                     <img
...
//                                         className="mt-2 bg-[#0098cc] hover:bg-[#007fa3] text-white font-semibold py-1 rounded transition"
//                                     >
//                                         View Details
//                                     </button>
//                                 </div>
...
//                     <div className="bg-white rounded-xl max-w-5xl w-full overflow-y-auto max-h-[90vh] p-6 flex flex-col md:flex-row gap-6 relative">
//                         <button
...
//                                 <h2 className="text-2xl font-bold text-[#062117]">Book a Session</h2>
//                                 <label className="block">
//                                     Check-in
//                                     <input
//                                         type="date"
...
//                                 <button
//                                     type="submit"
//                                     className="bg-[#0098cc] hover:bg-[#007fa3] text-white font-semibold py-2 rounded w-full transition"
//                                 >
//                                     Book Now
//                                 </button>
//                             </form>
...
//                         <div className="flex-1 border-l border-gray-200 pl-4 space-y-4 overflow-y-auto">
//                             {!showMoreDetails ? (
//                                 <>
//                                     <h2 className="text-2xl font-bold text-[#062117]">{selectedMentor.fullName}</h2>
//                                     <p><strong>Role:</strong> {selectedMentor.currentRole}</p>
//                                     <p><strong>Company:</strong> {selectedMentor.companyName}</p>
//                                     <p><strong>Experience:</strong> {selectedMentor.yearsOfExperience} yrs</p>
//                                     <p><strong>Location:</strong> {selectedMentor.location}</p>
//                                     <button
//                                         className="mt-2 text-[#0098cc] underline"
...
//                                 <div className="space-y-2">
//                                     <img
//                                         src={selectedMentor.profileImage || '/default-avatar.png'}
//                                         alt={selectedMentor.fullName}
//                                         className="w-32 h-32 object-cover rounded-full mx-auto"
//                                     />
//                                     <h2 className="text-2xl font-bold text-[#062117] text-center">{selectedMentor.fullName}</h2>
//                                     <p><strong>Role:</strong> {selectedMentor.currentRole}</p>
//                                     <p><strong>Company:</strong> {selectedMentor.companyName}</p>
//                                     <p><strong>Experience:</strong> {selectedMentor.yearsOfExperience} yrs</p>
//                                     <p><strong>Location:</strong> {selectedMentor.location}</p>
...
//                                     <p><strong>Languages:</strong> {selectedMentor.languages.join(', ')}</p>
//                                     <p><strong>Mentoring Style:</strong> {selectedMentor.mentoringStyle}</p>
//                                     <p><strong>Category:</strong> {selectedMentor.mentorCategory}</p>
//                                     <p><strong>Hourly Rate:</strong> ₹{selectedMentor.hourlyRate}</p>
//                                     <p><strong>Areas of Interest:</strong> {selectedMentor.areasOfInterest}</p>
//                                     <p><strong>Motivation Statement:</strong> {selectedMentor.motivationStatement}</p>
//                                     <p><strong>Highest Degree:</strong> {selectedMentor.highestDegree}</p>
//                                     <p><strong>Field of Study:</strong> {selectedMentor.fieldOfStudy}</p>
//                                     <p><strong>School:</strong> {selectedMentor.schoolName}</p>
//                                     <p><strong>Additional Courses:</strong> {selectedMentor.additionalCourses}</p>
//                                     <p><strong>Current Skills:</strong> {selectedMentor.currentSkills}</p>
//                                     <p><strong>Why Mentor:</strong> {selectedMentor.whyMentor}</p>
//                                     <p><strong>Greatest Achievement:</strong> {selectedMentor.greatestAchievement}</p>
//                                     <a href={selectedMentor.linkedinUrl} target="_blank" className="text-[#0098cc] underline">
//                                         LinkedIn
//                                     </a>
//                                     <button
//                                         className="mt-2 text-[#0098cc] underline"
