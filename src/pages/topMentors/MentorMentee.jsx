...
export default function MentorMenteePlatform() {
  ...
  return (
    <div className="min-h-screen py-10 px-5" style={{ backgroundColor: '#f0f0f0' }}>
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-14">
          ...
          <div className="flex flex-col justify-center">
            <p className="text-xs font-semibold mb-3 uppercase tracking-widest" style={{ color: '#0098cc' }}>
          ...
          <div className="relative">
            ...
            {/* Help Card */}
            <div className="absolute bottom-5 right-5 bg-white p-4 rounded-xl max-w-[220px] border border-gray-100">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="relative">
            ...
            {/* Stats Card */}
            <div className="absolute -bottom-6 left-5 right-5 bg-white p-4 rounded-xl border border-gray-100">
              <div className="grid grid-cols-3 gap-4">
                <div className="text-center">
                  <div className="flex justify-center mb-1">
                    <Users className="w-5 h-5" style={{ color: '#0098cc' }} />
                  </div>
                  <div className="text-xl font-bold" style={{ color: '#1a1a2e' }}>5000+</div>
                  <p className="text-xs text-gray-400">Active Mentees</p>
                </div>
                <div className="text-center border-l border-r border-gray-100">
                  <div className="flex justify-center mb-1">
                    <Target className="w-5 h-5" style={{ color: '#0098cc' }} />
                  </div>
                  <div className="text-xl font-bold" style={{ color: '#1a1a2e' }}>95%</div>
                ...
                <div className="text-center">
                  ...
                  <div className="text-xl font-bold" style={{ color: '#1a1a2e' }}>$150+</div>
                  <p className="text-xs text-gray-400">Avg. Hourly Rate</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-center mt-10 md:mt-0">
            ...
            <div>
              <button
                className="px-6 py-3 rounded-lg text-white text-sm font-semibold transition-all hover:opacity-90 inline-flex items-center gap-2"
                style={{ backgroundColor: '#1a1a2e' }}
