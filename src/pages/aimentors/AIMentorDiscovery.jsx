...
import { useGetAIMentorsQuery } from  "./Aimentorshipapislice"
...
const AIMentorDiscovery = () => {
    ...
    const { data: mentorsData, isLoading, isError, error, refetch } = useGetAIMentorsQuery(getFilters());
    ...
    const mapMentorData = (mentor) => {
        ...
        const reviews = Math.floor(150 + Math.random() * 250);
        const sessionsCompleted = Math.floor(200 + Math.random() * 450);

        return {
            _id: mentor._id,
            name: mentor.fullName,
            title: mentor.currentRole || 'AI/ML Mentor',
            company: mentor.companyName || 'Independent Researcher',
            ...
            hourlyRate: mentor.hourlyRate || 3000,
            ...
            modelsBuilt: Math.floor(10 + Math.random() * 35),
            papersPublished: `${Math.floor(5 + Math.random() * 25)}+`,
            usersImpacted: `${Math.floor(20 + Math.random() * 980)}M+`,
            email: mentor.email,
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-8">
                    <div className="flex items-center gap-3 mb-3">
                        <Brain className="w-10 h-10 text-[#0098cc]" />
                        ...
                        {!isLoading && !isError && (
                            <div className="mb-6 flex items-center justify-between">
                                <div className="text-gray-400">
                                    Showing <span className="text-[#0098cc] font-bold text-lg">{mentors.length}</span> AI mentors
                                </div>
                        ...
                        {isLoading && (
                            <div className="flex items-center justify-center py-20">
                                <div className="text-center">
                                    ...
                                    <p className="text-gray-400 text-lg">Loading AI mentors...</p>
                                </div>
                            </div>
                        )}
