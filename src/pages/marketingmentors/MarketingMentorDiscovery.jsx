...
import { useGetMarketingMentorsQuery } from "./marketingMentorapislice"
...
const MarketingMentorDiscovery = () => {
    ...
    const { data: mentorsData, isLoading, isError, error, refetch } = useGetMarketingMentorsQuery(getFilters());
    ...
    const mapMentorData = (mentor) => {
        ...
        return {
            ...
            title: mentor.currentRole || 'Marketing Mentor',
                        ...
                        {isLoading && (
                            <div className="flex items-center justify-center py-20">
                                <div className="text-center">
                                    ...
                                    <p className="text-gray-400 text-lg">Loading marketing mentors...</p>
                                </div>
                            </div>
                        )}
