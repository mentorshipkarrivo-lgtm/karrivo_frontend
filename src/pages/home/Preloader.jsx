...
//                     className="fixed inset-0 w-full h-screen bg-[#0a1a22] z-[100000] flex items-center justify-center"
//                 >
//                     {/* Logo Container */}
//                     <motion.div
...
//                             Karrivo<span className="text-red-900/30">.</span>
//                         </div>
...
//                         >
//                             Karrivo<span className="text-black">.</span>
//                         </motion.div>
//                     </motion.div>
...
const Preloader = () => {
    ...
    useEffect(() => {
        // Faster: water fill (0.8s) + tiny pause (0.2s) before shutter
        const timer = setTimeout(() => {
            setIsLoading(false);
        }, 1000);
