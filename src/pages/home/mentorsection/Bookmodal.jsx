...
// import React, { useState, useEffect } from "react";
// import { motion, AnimatePresence } from "framer-motion";
// import { X, Clock, Calendar, MessageSquare, Users, ChevronRight, Award, MapPin, Video, Gift, AlertCircle } from "lucide-react";
// import {
//   useCreateBookingMutation,
//   useCompleteBookingMutation,
...
//       if (response.isFreeSession && response.data.status === 'confirmed') {
//         // Free session - show success screen directly
//         setBookingData(prev => ({
//           ...prev,
...
//         setShowSuccessScreen(true);
//       } else {
//         // Paid session - navigate to payment
//         navigate('/payment', {
//           state: {
...
//               >
//                 <h2 className="text-2xl sm:text-3xl font-bold text-[#062117] mb-3">
//                   {isFreeSession ? '🎉 Free Session Confirmed!' : 'Booking Confirmed!'}
//                 </h2>
//                 <p className="text-gray-600 mb-8 text-sm sm:text-base">
//                   {isFreeSession
...
const BookingModal = ({ mentor, isOpen, onClose }) => {
  ...
  //     console.log(response.data.isFreeSession, "response.isFreeSession ")
  ...
  //       setShowSuccessScreen(true);
  //     } else {
  //       // // Paid session - navigate to payment with all necessary data
  //       // onClose();
  //       navigate('/payment', {
  //         state: {
  //           bookingId: response.bookingId || response.data?._id,
  ...
  //             currentRole: mentor.currentRole
  //           },
  //           zoomMeeting: response.zoomMeeting
  //         }
  //       });
  //     }
  //   } catch (error) {
