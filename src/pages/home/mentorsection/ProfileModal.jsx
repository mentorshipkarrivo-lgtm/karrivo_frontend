...
// //           const todayMidnight = new Date(toYMD(today) + "T00:00:00");
// //           const isPast = day < todayMidnight; const isToday = ymd === toYMD(today);
...
// //     apiResponse?.data?.mentorDetails?.availability ||
// //     apiResponse?.data?.availability ||
// //     [];
...
//     { icon: <Clock size={13} />, text: "30–45 min session" },
//   ];
...
//               {/* Banner image area */}
//               <div
//                 className="w-full h-40 sm:h-52 overflow-hidden"
//                 style={{ background: "#f0f4f8" }}
//               >
//                 {mentor.bannerImage ? (
//                   <img src={mentor.bannerImage} alt="banner" className="w-full h-full object-cover" />
//                 ) : (
//                   /* Decorative placeholder matching reference style */
//                   <div className="w-full h-full flex items-center justify-center overflow-hidden" style={{ background: "#eef2f7" }}>
//                     <p className="text-2xl sm:text-4xl font-bold text-gray-300 select-none tracking-tight px-6 text-center">
...
//                   <div
//                     className="w-24 h-24 sm:w-28 sm:h-28 rounded-2xl border-4 border-white bg-gray-100 overflow-hidden flex-shrink-0"
//                     style={{ marginTop: -40 }}
//                   >
//                     {mentor.profilePhoto || mentor.profileImage ? (
//                       <img src={mentor.profilePhoto || mentor.profileImage} alt={mentor.fullName} className="w-full h-full object-cover" />
...
//                     </button>
//                     <button onClick={() => setShowBooking(true)} className="btn btn-secondary" style={{ height: 38, fontSize: 12 }}>
//                       Ask a Question
//                     </button>
//                     <div className="relative">
//                       <button onClick={goToPlans} className="btn btn-secondary" style={{ height: 38, fontSize: 12 }}>
//                         View Pricing
//                       </button>
//                     </div>
//                   </div>
...
//             {/* ── Mentor info block ── */}
//             <div className="px-4 sm:px-8 lg:px-10 pt-3 pb-4 border-b border-gray-100">
//               {/* Name + badge */}
...
//                     <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
//                       {[
//                         mentor.currentRole && { label: "Current Role", value: `${mentor.currentRole}${mentor.companyName ? ` @ ${mentor.companyName}` : ""}`, icon: <Briefcase size={13} style={{ color: ACCENT }} /> },
//                         mentor.highestDegree && { label: "Degree", value: `${mentor.highestDegree.toUpperCase()}${mentor.fieldOfStudy ? ` · ${mentor.fieldOfStudy}` : ""}`, icon: <GraduationCap size={13} style={{ color: ACCENT }} /> },
//                         mentor.schoolName && { label: "Institution", value: mentor.schoolName, icon: <School size={13} style={{ color: ACCENT }} /> },
//                         mentor.yearsOfExperience && { label: "Experience", value: `${mentor.yearsOfExperience}+ years`, icon: <BadgeCheck size={13} style={{ color: ACCENT }} /> },
