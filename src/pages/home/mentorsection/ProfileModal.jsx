...
//       {/* ─── Page ─── */}
//       <div className="w-full bg-white min-h-[calc(100vh-61px)] overflow-x-hidden" style={{ fontFamily: "Cambria" }}>
...
//                   className="flex items-center gap-1.5 px-3 py-1.5 rounded-full border text-xs font-semibold transition-colors duration-150 flex-shrink-0"
...
//           {/* ══ RIGHT SIDEBAR (lg+) ══ */}
//           <div className="hidden lg:flex flex-col w-[200px] xl:w-[340px] flex-shrink-0 border-l border-gray-200 bg-white sticky top-[61px] self-start max-h-[calc(100vh-61px)] overflow-visible">
