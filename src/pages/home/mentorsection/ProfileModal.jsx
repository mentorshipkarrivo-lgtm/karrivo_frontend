...
// const ACCENT = "#0098cc";
// const WHITE = "#ffffff";
// const BANNER_BG = "#1a1a2e"; /* same navy as PRIMARY – matches your existing palette */
...
//       className="inline-flex items-center gap-2 px-3.5 py-2 bg-white border border-gray-200 rounded-lg text-gray-800 text-sm font-semibold"
//     >
...
//         <button
//           onClick={onClose}
//           className="inline-flex items-center justify-center gap-1.5 h-10 px-4 rounded-lg text-sm font-bold border-2 border-[#1a1a2e] bg-white text-[#1a1a2e] hover:bg-[#1a1a2e] hover:text-white transition-colors duration-150 active:scale-95 whitespace-nowrap"
//           style={{ fontFamily: "Cambria" }}
//         >
//           <ArrowLeft size={14} /> Back
//         </button>
//         <h2 className="text-xl sm:text-2xl font-bold text-gray-900" style={{ fontFamily: "Cambria" }}>
...
//               )}
//             </div>
//             <h3 className="text-base font-bold text-gray-900 leading-tight" style={{ fontFamily: "Cambria" }}>
//               {mentor.fullName}
//             </h3>
//             {mentor.currentRole && (
//               <p className="text-sm text-gray-500 mt-1" style={{ fontFamily: "Cambria" }}>
...
//             <h3 className="text-base font-bold text-gray-900 mb-5" style={{ fontFamily: "Cambria" }}>
...
//                       className="inline-flex items-center justify-center gap-1.5 h-11 px-6 rounded-lg text-base font-bold border-2 border-[#1a1a2e] bg-[#1a1a2e] text-white hover:bg-[#0098cc] hover:border-[#0098cc] transition-colors duration-150 active:scale-95 whitespace-nowrap"
//                       style={{ fontFamily: "Cambria" }}
//                     >
//                       Confirm Booking →
//                     </button>
...
//   return (
//     <div className="mb-6 pb-6 border-b border-gray-200" style={{ fontFamily: "Cambria" }}>
...
//         className="inline-flex items-center justify-center gap-2 h-11 px-6 rounded-lg text-base font-bold border-2 border-[#1a1a2e] bg-[#1a1a2e] text-white hover:bg-[#0098cc] hover:border-[#0098cc] transition-colors duration-150 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed mt-3"
//         style={{ fontFamily: "Cambria" }}>
...
//   /* Photo overlap measurement
//      Banner  = 200px tall
//      Photo   = 240px tall, starts 16px from banner top
//      Overlap = photo bottom - banner bottom = (16 + 240) - 200 = 56px below boundary */
//   const PHOTO_W = 200; /* px  — width of the photo card            */
//   const PHOTO_H = 280; /* px  — full height of photo card          */
//   const PHOTO_TOP = 54;  /* px  — gap from top of banner to photo    */
//   const BANNER_H = 270; /* px  — total height of the dark banner    */
//   const PHOTO_OFFSET = (PHOTO_TOP + PHOTO_H) - BANNER_H; /* 56px hangs below */
//   const LEFT_PAD = 40;  /* px  — consistent left edge for everything */
...
//   /* linkedin url — check both possible field names */
...
//             <button onClick={() => navigate("/explore-mentors")}
//               className="text-base font-bold text-gray-700 hover:text-gray-900 transition-colors"
//               style={{ fontFamily: "Cambria" }}>Explore Mentors</button>
//           </div>
//           <div className="flex items-center gap-2">
//             <button onClick={() => navigate("/login")} className={`${btnSecondary} !h-10 !px-5 !text-sm`} style={{ fontFamily: "Cambria" }}>
//               Login
//             </button>
//             <button className="md:hidden w-10 h-10 flex items-center justify-center border border-gray-200 rounded-lg"
...
//             <button onClick={() => { navigate("/explore-mentors"); setMobileMenuOpen(false); }}
//               className="block w-full text-left text-base font-semibold text-gray-700 py-2.5"
//               style={{ fontFamily: "Cambria" }}>Explore Mentors</button>
//           </div>
//         )}
//       </nav>
...
//             {/* ════════════════════════════════════════════
//                 BANNER — navy bg, photo straddles boundary
//                 ════════════════════════════════════════════ */}
//             <div className="relative" style={{ background: BANNER_BG, height: BANNER_H }}>

//               {/* ── Profile photo ──
//                   Starts PHOTO_TOP px from the banner top,
//                   so it naturally extends PHOTO_OFFSET px below the banner. */}
...
//                   boxShadow:
//                     "0 10px 30px rgba(0,0,0,0.18), 0 4px 12px rgba(0,0,0,0.08)",
//                   zIndex: 10,
//                 }}
//               >
//                 {mentor.profilePhoto || mentor.profileImage ? (
...
//                     style={{
//                       background: `linear-gradient(135deg, ${ACCENT}, #1a1a2e)`,
//                       fontFamily: "Cambria",
//                     }}
//                   >
//                     {initials}
...
//               {/* ── Name / Role / LinkedIn — vertically centred inside banner ── */}
//               <div
//                 className="absolute  bottom-0 flex flex-col justify-center gap-2"
//                 style={{
//                   left: LEFT_PAD + PHOTO_W + 28,  /* photo left + photo width + gap */
//                   right: 24,
//                   paddingTop: 8,
//                   paddingBottom: 38,
//                 }}
//               >
//                 {/* Top Mentor badge — only when isStar */}
//                 {mentor.isStar && (
//                   <div
...
//                     </span>
//                     <span className="text-xs font-bold text-white" style={{ fontFamily: "Cambria" }}>
//                       Top Mentor
//                     </span>
//                   </div>
//                 )}
...
//                     className="flex items-center gap-1.5 px-4 py-2 rounded-full border text-sm font-semibold transition-colors duration-150"
//                     style={{
//                       borderColor: wishlist ? "#ef4444" : "#d1d5db",
...
//                       }}
//                     >
//                       <FileText size={14} stroke="#6b7280" />
//                       Portfolio
//                       <ExternalLink size={12} stroke="#6b7280" />
//                     </a>
//                   )}
//                 </div>
//               </div>
...
//             {/* ── Action bar — paddingTop clears the photo that hangs below ── */}
//             <div
//               className="bg-white border-b border-gray-100 flex flex-wrap items-center justify-end gap-3"
//               style={{
//                 paddingLeft: LEFT_PAD,
//                 paddingRight: 24,
//                 paddingTop: PHOTO_OFFSET + 14, // 56 + 14 = 70px clears photo
//                 paddingBottom: 16,
//               }}
//             >
//               {/* Wishlist / Save */}
...
//                 className={`${btnSecondary} !h-9 !px-4 !text-sm`}
//                 style={{ fontFamily: "Cambria" }}
//               >
//                 Book a Trial Session
//               </button>
...
//             {/* ── Mentor stats / bio block ── */}
//             <div className="pt-5 pb-5 border-b border-gray-100" style={{ paddingLeft: LEFT_PAD, paddingRight: 24 }}>
//               <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-5" style={{ fontFamily: "Cambria" }}>
//                 About                    </h3>              {bioText && (
...
//                     <span className="text-base text-gray-500" style={{ fontFamily: "Cambria" }}>
...
//             {/* ── Content sections ── */}
//             <div className="pb-24 lg:pb-10" style={{ paddingLeft: LEFT_PAD, paddingRight: 24 }}>
//               {showBooking && (
...
//                         mentor.yearsOfExperience && {
//                           label: "Experience",
//                           value: `${mentor.yearsOfExperience}+ Years of Experience`,
...
//                       ))}
//                     </div>
//                     {/* {(linkedInUrl || mentor.resumeLink) && (
//                       <div className="flex flex-wrap gap-2.5 mt-5 pt-5 border-t border-gray-100">
//                         {linkedInUrl && (
//                           <a href={linkedInUrl} target="_blank" rel="noopener noreferrer"
//                             className={`${btnGhost} !h-10 !px-4 !text-sm`} style={{ fontFamily: "Cambria" }}>
...
//                   <div className="py-6 border-b border-gray-200">
//                     <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2" style={{ fontFamily: "Cambria" }}>
//                       Work Experience
//                     </h3>
...
//                         <span key={i} className="px-4 py-2 border border-gray-200 rounded-lg text-sm font-semibold text-gray-700"
...
//                           ))}
//                         </div>
//                         <p className="text-base leading-7 text-gray-600 mb-4" style={{ fontFamily: "Cambria" }}>
...
//                               </div>
//                             )}
//                             <span className="text-base font-semibold text-gray-800" style={{ fontFamily: "Cambria" }}>
...
//                       </div>
//                     )) : (
//                       <p className="text-base text-gray-500" style={{ fontFamily: "Cambria" }}>
...
//                   <Calendar size={16} /> Book a Trial Session
//                 </button>
//               </div>
...
//                       <span className="text-base font-medium text-gray-500">/Session </span>
//                     </p>
//                   </div>
//                 )}
...
const ExperienceItem = ({ exp, isLast }) => {
  ...
  return (
    <div className={`flex gap-3 sm:gap-5 py-5 sm:py-6 ${!isLast ? "border-b border-gray-100" : ""}`}>
      <div className="w-[90px] sm:w-[130px] flex-shrink-0 pt-0.5">
        {dateRange && (
...
const SkillChip = ({ skill }) => {
  ...
  return (
    <span
      style={{ fontFamily: "Cambria" }}
      className="inline-flex items-center gap-2 px-3 py-1.5 sm:px-3.5 sm:py-2 bg-white border border-gray-200 rounded-lg text-gray-800 text-xs sm:text-sm font-semibold"
    >
      <span className="w-4 h-4 flex items-center justify-center flex-shrink-0">
        {icon && !imgErr ? (
          <img src={icon} alt={skill} className="w-4 h-4 object-contain" onError={() => setImgErr(true)} />
  ...
  return (
    <div className="w-full select-none" style={{ fontFamily: "Cambria" }}>
      <div className="flex items-center justify-between mb-4">
        ...
        <span className="text-sm sm:text-base font-bold text-gray-900">{MONTH_NAMES[month]} {year}</span>
        <button
          onClick={() => setViewMonth(new Date(year, month + 1, 1))}
          className="w-8 h-8 rounded-full flex items-center justify-center hover:bg-gray-100 transition-colors"
        >
  ...
  return (
    <div className="animate-[slideInRight_0.35s_cubic-bezier(0.22,1,0.36,1)_forwards]" style={{ fontFamily: "Cambria" }}>
      <div className="flex items-center gap-3 mb-6 pb-5 border-b border-gray-200">
        ...
        <h2 className="text-lg sm:text-2xl font-bold text-gray-900" style={{ fontFamily: "Cambria" }}>
          Book a Trial Session
        </h2>
      </div>

      <div className="flex flex-col lg:flex-row border border-gray-200 rounded-xl overflow-hidden">
        <div className="lg:w-[290px] xl:w-[310px] flex-shrink-0 border-b lg:border-b-0 lg:border-r border-gray-200 p-4 sm:p-5 flex flex-col gap-4 sm:gap-5">
          <div className="pb-4 sm:pb-5 border-b border-gray-200">
            ...
            <h3 className="text-sm sm:text-base font-bold text-gray-900 leading-tight" style={{ fontFamily: "Cambria" }}>
              {mentor.fullName}
            </h3>
            {mentor.currentRole && (
              <p className="text-xs sm:text-sm text-gray-500 mt-1" style={{ fontFamily: "Cambria" }}>
                {mentor.currentRole}{mentor.companyName ? ` · ${mentor.companyName}` : ""}
              </p>
            )}
          </div>
              ...
              <div className="animate-[fadeIn_0.25s_ease_forwards]">
                  ...
                  {slotsForSelectedDate.map((slot) => {
                    ...
                    return (
                      <button
                        key={slot._id}
                        onClick={() => setSelectedSlot(chosen ? null : slot)}
                        className="py-2.5 sm:py-3 px-2 sm:px-2.5 rounded-lg border text-xs sm:text-sm font-bold transition-all duration-150 relative hover:scale-[1.03] active:scale-95"
                        style={{
                          background: chosen ? PRIMARY : WHITE,
                          color: chosen ? WHITE : slot.isBooked ? "#9ca3af" : ACCENT,
                          borderColor: chosen ? PRIMARY : slot.isBooked ? "#e5e7eb" : ACCENT,
                ...
                {selectedSlot && (
                  <div className="animate-[fadeIn_0.25s_ease_forwards] mt-5 sm:mt-6 flex flex-col sm:flex-row gap-3 items-start sm:items-center">
                    ...
                    <button
                      onClick={() => onSlotConfirmed(selectedSlot)}
                      className="w-full sm:w-auto inline-flex items-center justify-center gap-1.5 h-11 px-5 sm:px-6 rounded-lg text-sm sm:text-base font-bold border-2 border-[#1a1a2e] bg-[#1a1a2e] text-white hover:bg-[#0098cc] hover:border-[#0098cc] transition-colors duration-150 active:scale-95 whitespace-nowrap"
                      style={{ fontFamily: "Cambria" }}
                    >
                      Confirm Booking →
                    </button>
    ...
    <>
      ...
      <nav className="w-full bg-white border-b border-gray-100 z-50 sticky top-0" style={{ fontFamily: "Cambria" }}>
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-12 py-3 sm:py-3.5 flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            <button onClick={() => navigate("/login")} className={`${btnSecondary} !h-9 !px-4 !text-sm`} style={{ fontFamily: "Cambria" }}>
              Login
            </button>
            <button className="md:hidden w-9 h-9 flex items-center justify-center border border-gray-200 rounded-lg"
              onClick={() => setMobileMenuOpen(v => !v)}>
              {mobileMenuOpen ? <X size={16} /> : <Menu size={16} />}
            </button>
          </div>
      ...
      <div className="w-full bg-white min-h-[calc(100vh-61px)]" style={{ fontFamily: "Cambria" }}>
        <div className="max-w-[1400px] mx-auto flex flex-col lg:flex-row">
          ...
          <div className="flex-1 min-w-0 lg:overflow-y-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
            ...
            {/* ════════════════════════════════════════════
                RESPONSIVE BANNER — mobile stacked, desktop side-by-side
                ════════════════════════════════════════════ */}

            {/* ── MOBILE BANNER (< lg) ── */}
            <div className="lg:hidden" style={{ background: BANNER_BG }}>
              {/* Top section: photo left + name/role right */}
              <div className="flex items-end gap-4 px-4 pt-6 pb-0">
                {/* Photo */}
                <div
                  ...
                  style={{
                    ...
                    marginBottom: -28, /* hangs below banner */
                    position: "relative",
                    zIndex: 10,
                  }}
                >
                ...
                {/* Name + role inside banner */}
                <div className="flex-1 min-w-0 pb-4">
                  {mentor.isStar && (
                    <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full mb-2"
                      style={{ background: "rgba(255,255,255,0.12)", border: "1px solid rgba(255,255,255,0.25)" }}>
                      <span className="w-2.5 h-2.5 rounded-full flex items-center justify-center" style={{ background: ACCENT }}>
                        <span className="w-1.5 h-1.5 rounded-full block bg-white" />
                      </span>
                      <span className="text-[11px] font-bold text-white" style={{ fontFamily: "Cambria" }}>Top Mentor</span>
                    </div>
                  )}
                  <h1 className="text-xl font-bold text-white leading-snug truncate" style={{ fontFamily: "Cambria" }}>
                    {mentor.fullName}
                  </h1>
                  {(mentor.currentRole || mentor.jobTitle) && (
                    <p className="text-xs text-white/80 mt-1 truncate" style={{ fontFamily: "Cambria" }}>
                      {mentor.currentRole || mentor.jobTitle}
              ...
              {/* Save / LinkedIn / Portfolio row — below banner */}
              <div className="bg-white pt-9 pb-3 px-4 flex flex-wrap items-center gap-2 border-b border-gray-100">
                <button
                  onClick={() => setWishlist((v) => !v)}
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-full border text-xs font-semibold transition-colors duration-150"
                  style={{ borderColor: wishlist ? "#ef4444" : "#d1d5db", color: wishlist ? "#ef4444" : "#6b7280", background: "#fff" }}
                >
                  <Heart size={12} fill={wishlist ? "#ef4444" : "none"} stroke={wishlist ? "#ef4444" : "#6b7280"} />
                  {wishlist ? "Saved" : "Save"}
                </button>
                {linkedInUrl && (
                  <a href={linkedInUrl} target="_blank" rel="noopener noreferrer"
                ...
                <div className="ml-auto flex items-center gap-2">
                  <button onClick={() => setShowBooking(true)} className={`${btnSecondary} !h-8 !px-3 !text-xs`}>
                    Book Trial
                  </button>
                  <button onClick={goToPlans} className={`${btnSecondary} !h-8 !px-3 !text-xs`}>
                    Pricing
                  </button>
                </div>
              </div>
            ...
            <div className="hidden lg:block relative" style={{ background: BANNER_BG, height: 270 }}>
              {/* Photo — starts 54px from top, 280px tall → hangs 64px below banner */}
              <div
                className="absolute overflow-hidden bg-white"
                style={{
                  left: 40,
              ...
              {/* Name / Role / Badges — right of photo */}
              <div
                className="absolute bottom-0 flex flex-col justify-center gap-2"
              ...
              >
                ...
                <h1 className="text-2xl xl:text-3xl font-bold text-white leading-snug" style={{ fontFamily: "Cambria" }}>
                  {mentor.fullName}
                </h1>
                {(mentor.currentRole || mentor.jobTitle) && (
                  <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full w-fit"
                    ...
                    <Briefcase size={14} color="#0a66c2" strokeWidth={2.2} />
                    <span>{mentor.currentRole || mentor.jobTitle}</span>
                    {mentor.companyName && (
                      <><span style={{ opacity: 0.6 }}>•</span><Building2 size={14} color="#60a5fa" strokeWidth={2.2} /><span>{mentor.companyName}</span></>
                    )}
                  </div>
                )}
                <div className="flex items-center gap-3 mt-1">
                  <button onClick={() => setWishlist((v) => !v)}
                    className="flex items-center gap-1.5 px-4 py-2 rounded-full border text-sm font-semibold transition-colors duration-150"
                    style={{ borderColor: wishlist ? "#ef4444" : "#d1d5db", color: wishlist ? "#ef4444" : "#6b7280", fontFamily: "Cambria", background: "#fff" }}>
                    <Heart size={14} fill={wishlist ? "#ef4444" : "none"} stroke={wishlist ? "#ef4444" : "#6b7280"} />
                    {wishlist ? "Saved" : "Save"}
                  </button>
                  {linkedInUrl && (
                    <a href={linkedInUrl} target="_blank" rel="noopener noreferrer"
                      className="w-9 h-9 flex items-center justify-center rounded-full" style={{ background: "#0a66c2" }}>
                      <LinkedInIcon />
                    </a>
                  )}
                  {mentor.resumeLink && (
            ...
            {/* ── Desktop Action bar — clears photo overhang (64px below 270px banner) ── */}
            <div
            ...
            {/* ── Content wrapper — consistent padding at all breakpoints ── */}
            <div className="px-4 sm:px-6 lg:px-10">
              ...
              <div className="pt-5 pb-5 border-b border-gray-100">
                ...
                {bioText && (
                  <div className="max-w-2xl mb-4">
                    <p className="text-sm sm:text-base leading-7 text-gray-600" style={{ fontFamily: "Cambria" }}>{bio}</p>
                    {bioLong && (
                      <button onClick={() => setShowFullBio(!showFullBio)}
                        className="text-sm font-bold hover:underline mt-1.5" style={{ color: ACCENT, fontFamily: "Cambria" }}>
                        {showFullBio ? "read less" : "read more"}
                ...
                <div className="flex flex-wrap items-center gap-x-4 sm:gap-x-6 gap-y-2.5 mt-2.5">
                  {avgRating && (
                    <div className="flex items-center gap-2">
                      <Star size={14} fill="#f59e0b" stroke="none" />
                      <span className="text-sm sm:text-base font-bold text-gray-800" style={{ fontFamily: "Cambria" }}>{avgRating}</span>
                      <span className="text-sm sm:text-base text-gray-500" style={{ fontFamily: "Cambria" }}>
                        ({totalReviews} {totalReviews === 1 ? "Review" : "Reviews"})
                      </span>
                    </div>
                  )}
                  {mentor.totalSessionMins && (
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm sm:text-base font-bold text-gray-800" style={{ fontFamily: "Cambria" }}>{mentor.totalSessionMins}+</span>
                      <span className="text-sm sm:text-base text-gray-500" style={{ fontFamily: "Cambria" }}>Mins</span>
                    </div>
                  )}
                  {mentor.yearsOfExperience && (
                    <div className="flex items-center gap-2">
                      <Briefcase size={14} style={{ color: ACCENT }} />
                      <span className="text-sm sm:text-base font-bold text-gray-800" style={{ fontFamily: "Cambria" }}>{mentor.yearsOfExperience}+</span>
                      <span className="text-sm sm:text-base text-gray-500" style={{ fontFamily: "Cambria" }}>Years Exp</span>
                    </div>
                  )}
                </div>
                {affiliations.length > 0 && (
                  <div className="flex flex-wrap items-center gap-4 sm:gap-5 mt-4 pt-4 border-t border-gray-100">
                    {affiliations.map(({ label, icon }) => (
                      <div key={label} className="flex items-center gap-2">
                        {icon}
                        <span className="text-xs sm:text-sm text-gray-600 font-medium" style={{ fontFamily: "Cambria" }}>{label}</span>
                      </div>
                    ))}
                    {mentor.location && (
                      <div className="flex items-center gap-2">
                        <MapPin size={14} style={{ color: ACCENT }} />
                        <span className="text-xs sm:text-sm text-gray-600 font-medium" style={{ fontFamily: "Cambria" }}>{mentor.location}</span>
                      </div>
                    )}
                  </div>
                )}
                    ...
                    <div className="py-5 sm:py-6 border-b border-gray-200">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 sm:gap-3">
                        {[
                          ...
                          <div key={label} className="flex items-center gap-3 border border-gray-100 rounded-lg p-3 sm:p-4">
                    ...
                    <div className="space-y-4 sm:space-y-5">
                      {reviews?.length > 0 ? reviews.map((review, index) => (
                        <div key={review._id || index} className="border-b border-gray-100 pb-4 sm:pb-5">
                          ...
                          <p className="text-sm sm:text-base leading-7 text-gray-600 mb-3 sm:mb-4" style={{ fontFamily: "Cambria" }}>
                            {review.review || review.comment}
                          </p>
                          <div className="flex items-center justify-between gap-3 flex-wrap">
                            <div className="flex items-center gap-2 sm:gap-3">
                              ...
                              <span className="text-xs sm:text-base font-semibold text-gray-800" style={{ fontFamily: "Cambria" }}>
                                {review.user?.name || "Anonymous User"}
                              </span>
                            </div>
                            <span className="text-xs sm:text-sm text-gray-400" style={{ fontFamily: "Cambria" }}>
                              {review.createdAt
                                ? new Date(review.createdAt).toLocaleDateString("en-IN", { day: "numeric", month: "short", year: "numeric" })
                                : "Recently"}
                            </span>
          ...
          {/* ══ RIGHT SIDEBAR (lg+) ══ */}
          <div className="hidden lg:flex flex-col w-[300px] xl:w-[340px] flex-shrink-0 border-l border-gray-200 bg-white sticky top-[61px] h-[calc(100vh-61px)] overflow-y-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
            <div className="flex flex-col gap-0 divide-y divide-gray-100">
              ...
              <div className="p-5 xl:p-6">
                ...
                <div className="grid grid-cols-2 gap-x-3 gap-y-2 xl:gap-y-2.5 mb-4 xl:mb-5">
                  {trialBenefits.map((item, i) => (
                    <div key={i} className="flex items-center gap-2">
                      <span style={{ color: ACCENT }} className="flex-shrink-0">{item.icon}</span>
                      <span className="text-xs xl:text-sm text-gray-600" style={{ fontFamily: "Cambria" }}>{item.text}</span>
                    </div>
                  ))}
                </div>
      ...
      {/* Mobile sticky CTA */}
      <div className="fixed bottom-0 inset-x-0 z-40 lg:hidden bg-white border-t border-gray-200 px-3 sm:px-4 py-2.5 sm:py-3 flex gap-2 sm:gap-2.5">
        <button onClick={goToPlans} className={`${btnSecondary} flex-1 !h-11 !text-sm`} style={{ fontFamily: "Cambria" }}>
          View Plans
        </button>
        <button onClick={() => setShowBooking(true)} className={`${btnPrimary} flex-1 !h-11 !text-sm`} style={{ fontFamily: "Cambria" }}>
          <Calendar size={15} /> Book Trial
        </button>
      </div>
