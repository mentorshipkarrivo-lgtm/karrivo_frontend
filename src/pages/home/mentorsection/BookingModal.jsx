...
// //     const authToken = localStorage.getItem("authToken");
// //     if (!authToken) {
// //       // Build redirect URL with booking context
// //       const redirectUrl = `/book-session?mentorId=${mentor?._id}`;
...
//       localStorage.setItem("pendingBookingMentorId", mentor?._id || "");
//       localStorage.setItem("selectedMentorName", mentor.fullName);
//       navigate(`/login?mentorId=${mentor?._id}`); if (mentor?.fullName) {
//         localStorage.setItem("selectedMentorName", mentor.fullName);
//       }
