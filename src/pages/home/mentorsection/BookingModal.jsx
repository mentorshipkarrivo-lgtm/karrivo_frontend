  ...
  const handleBookingSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        createZoomMeeting: isFreeSession,
      };
      ...
      // Check if this is a free session that was auto-confirmed
      if (response.data.isFreeSession) {
        // Free session - Zoom created, show success toast
        showToast('Free session confirmed! Check your email for Zoom meeting details.', 'success');
        onClose();
        resetForm();
        navigate("/mentee/dashboard");
      } else {
      ...
      console.error("Booking creation failed:", error);
      showToast(error?.message || error?.data?.message || "Failed to create booking. Please try again.", 'error');
    }
  };
