...
//   const [bookingId, setBookingId] = useState(null);  // ← ADD THIS
...
//       console.log(result, "result2e34", result?.booking_id)

//       setSubscriptionId(result?.data?._id);
//       setBookingId(result?.booking_id);        // ← ADD THIS
...
//                   <span style={{ fontWeight: 700, color: '#fff' }}>{r.value}</span>
//                 </div>
//               ))}
//             </div>
//           )}
...
//                           Send exactly <strong style={{ color: CREAM }}>₹{paymentPlan.totalPrice.toLocaleString('en-IN')}</strong>. Wrong amounts delay activation.
//                         </p>
//                       </div>
//                     </div>
//                   )}
