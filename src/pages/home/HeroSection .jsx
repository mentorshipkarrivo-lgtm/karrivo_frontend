...
// //       {/* ── Inner wrapper: fills screen, centers content ── */}
// //       <div className="flex-1 flex flex-col justify-center w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 overflow-hidden">
...
// //             <h1 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold leading-tight text-[#0a1a22]">
// //               THE WORLD'S LEADING<br />
// //               MENTORSHIP PLATFORM FOR<br />
// //               TOMORROW'S{' '}
...
// //           {/* Right — Profile + Goals */}
// //           <div className="flex flex-col justify-center items-start lg:items-end gap-5">

// //             {/* Profile progress row */}
// //             <div className="flex items-center gap-4">
// //               <div className="w-11 h-11 rounded-full overflow-hidden shadow-md shrink-0">
// //                 <img
// //                   src="https://i.pravatar.cc/150?img=10"
// //                   alt="User profile"
// //                   className="w-full h-full object-cover"
// //                 />
// //               </div>
// //               <div className="w-28 h-2 rounded-full bg-[#e0f4fc] overflow-hidden">
// //                 <div className="h-full w-[75%] bg-[#0098cc] rounded-full" />
// //               </div>
// //               <div className="w-9 h-9 rounded-full border border-[#0098cc] flex items-center justify-center shrink-0">
...
// //         {/* ── Divider ── */}
// //         <div className="w-full h-px bg-[#0098cc]/20 mb-6" />

// //         {/* ── Marquee ── */}
// //         <div className="overflow-hidden mb-6 -mx-4 sm:-mx-6 lg:-mx-8">
...
// //                 style={{ width: '130px', height: '170px', marginRight: '14px' }}
// //               >
// //                 <img
// //                   src={profile.image}
// //                   alt={`Mentor ${profile.id}`}
...
//       <div className="flex-1 flex flex-col justify-center w-full px-4 sm:px-8 lg:px-14 xl:px-20 py-8 overflow-hidden">
...
//         {/* ── Marquee ── */}
//         <div className="overflow-hidden mb-6 -mx-4 sm:-mx-8 lg:-mx-14 xl:-mx-20">
//           <div className="marquee-track">
//             {loopedProfiles.map((profile, idx) => (
//               <div
//                 key={idx}
//                 className="relative flex-shrink-0 rounded-2xl overflow-hidden shadow-md
//                            transition-transform duration-300 hover:scale-105 hover:shadow-xl"
//                 style={{ width: '180px', height: '240px', marginRight: '16px' }}
//               >
//                 <img
//                   src={profile.image}
//                   alt={`Mentor ${profile.id}`}
