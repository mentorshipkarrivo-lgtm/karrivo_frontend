...
//         {/* Single outlined box with 3 columns */}
//         <div style={{
//           display: "grid",
...
//               {/* Description */}
//               <p style={{ color: "#a8d5c2", fontSize: "0.9rem", lineHeight: 1.75, marginBottom: "28px" }}>
//                 {step.description}
//               </p>
          ...
          {steps.map((step, index) => (
            <div
              ...
              style={{
                ...
                textAlign: "left",
                borderRight: index !== steps.length - 1 ? "1px solid rgba(0,152,204,0.3)" : "none",
                /* ✅ Flex column so button always sticks to bottom */
                display: "flex",
            ...
            >
              ...
              {/* Title */}
              <h3 style={{ color: "#ffffff", fontWeight: 700, fontSize: "1.15rem", marginBottom: "12px", margin: "0 0 12px 0" }}>
                {step.title}
              </h3>
