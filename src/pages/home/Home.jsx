...
// //         {/* Centered Content */}
// //         <div className="relative flex-1 flex items-center justify-center w-full px-4 sm:px-6 lg:px-8">
...
// //                   className="w-full pl-12 pr-36 py-4 rounded-full bg-white text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 shadow-lg text-base transition-all border-none"
// //                 />
// //                 <button
// //                   type="submit"
...
// //                     isSearchValid
// //                       ? "bg-[#0098cc] text-white hover:bg-[#007aaa] shadow-md border-none"
...
// // Shared animation variants for the page-load sequence
// const fadeUp = {
...
//   return (
//     <>
//       {/* Hero Section — full viewport height, flat background, no shadows */}
//       <div className="h-screen bg-[#f6fafc] flex flex-col overflow-hidden">
...
//               custom={0.1}
//               variants={fadeUp}
//               className="text-4xl sm:text-5xl lg:text-6xl font-bold text-[#0a1a22] mb-6 leading-tight"
//             >
//               Connect with{" "}
//               <span className="text-[#0098cc]">
//                 Expert Mentors
...
//                   value={searchQuery}
//                   onChange={(e) => setSearchQuery(e.target.value)}
//                   className="w-full pl-12 pr-36 py-4 rounded-full bg-white text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#0098cc] border border-[#0098cc]/20 text-base transition-colors"
//                 />
//                 <button
//                   type="submit"
//                   disabled={!isSearchValid}
//                   className="absolute right-2 top-1/2 -translate-y-1/2 px-6 py-2.5 rounded-full font-medium transition-colors duration-200 flex items-center gap-2 border-none bg-[#2d2d4e] text-white hover:bg-[#2d2d4e]/90 disabled:cursor-not-allowed"
//                 >
//                   Find Mentors
//                   <ArrowRight className="w-4 h-4" />
//                 </button>
...
//                   key={link}
//                   onClick={() => handleQuickLinkClick(link)}
//                   className="px-3 py-1.5 rounded-full text-sm font-medium bg-white text-gray-700 hover:bg-[#f0faff] hover:text-[#0098cc] transition-colors duration-200 border border-[#0098cc]/20"
//                 >
//                   {link}
//                 </button>
//               ))}
...
//                     src={profile}
//                     alt={`Mentor ${index + 1}`}
//                     className="w-12 h-12 rounded-full border-4 border-[#f6fafc] hover:scale-110 transition-transform cursor-pointer"
//                   />
//                 ))}
//               </div>
//               <div className="ml-4 text-left">
//                 <p className="text-sm font-semibold text-[#0a1a22]">10,000+ Expert Mentors</p>
//                 <p className="text-xs text-gray-500">Ready to guide you</p>
//               </div>
//             </motion.div>
                ...
                {MENTOR_PROFILES.map((profile, index) => (
                  <div key={index} className="relative w-10 h-10 sm:w-12 sm:h-12">
                    ...
                    <img
                      src={profile}
                      alt={`Mentor ${index + 1}`}
                      className="relative w-10 h-10 sm:w-12 sm:h-12 rounded-full border-2 sm:border-4 border-[#f6fafc] hover:scale-110 transition-transform cursor-pointer"
                    />
                  </div>
                ))}
              </div>
              <div className="text-center sm:text-left mt-1 sm:mt-0 sm:ml-2">
                <p className="text-sm font-semibold text-[#0a1a22]">10,000+ Expert Mentors</p>
                <p className="text-xs text-gray-500">Ready to guide you</p>
              </div>
            </motion.div>
