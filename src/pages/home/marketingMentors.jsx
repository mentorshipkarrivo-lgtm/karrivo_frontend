...
import { Search, Filter, Star, Briefcase, Target, Clock, MapPin, TrendingUp, Users, Lightbulb, Megaphone } from 'lucide-react';
    ...
    const mentors = [
        {
            ...
            expertise: ['Growth Hacking', 'User Acquisition', 'Viral Marketing'],
        ...
        },
        {
            ...
            expertise: ['Content Strategy', 'Copywriting', 'SEO Content'],
            availability: 'Available',
            hourlyRate: 2200,
        ...
        },
        {
            ...
            expertise: ['Paid Ads', 'ROI Optimization', 'Attribution'],
            availability: 'Busy',
            hourlyRate: 2400,
        ...
        },
        {
            ...
            expertise: ['Brand Positioning', 'Market Research', 'Campaign Strategy'],
            availability: 'Available',
            hourlyRate: 3500,
        ...
        },
        {
            ...
            expertise: ['Instagram Growth', 'Influencer Marketing', 'Community Building'],
            availability: 'Available',
            hourlyRate: 2600,
        ...
        },
        {
            ...
            expertise: ['Technical SEO', 'Google Ads', 'Keyword Research'],
            availability: 'Available',
            hourlyRate: 2500,
        ...
        },
        {
            ...
            expertise: ['Digital Strategy', 'Marketing Automation', 'Analytics'],
            availability: 'Available',
            hourlyRate: 1800,
        ...
        },
        {
            ...
            expertise: ['Email Campaigns', 'Marketing Automation', 'Segmentation'],
            availability: 'Busy',
            hourlyRate: 2300,
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-8">
                    <div className="flex items-center gap-3 mb-3">
                        <Megaphone className="w-10 h-10 text-[#0098cc]" />
                        <h1 className="text-3xl md:text-4xl font-bold text-white">
                            Find Your Marketing Mentor
                        </h1>
                    </div>
                    <p className="text-gray-400">Connect with marketing experts who've driven growth and built powerful brands</p>
                </div>
                                    ...
                                    <div className="pt-14 px-6 pb-6">
                                        ...
                                        <div className="grid grid-cols-2 gap-2 mb-3">
                                            <div className="bg-[#062117] rounded-lg px-3 py-2 border border-[#0098cc]/20">
                                                ...
                                                <div className="text-white text-sm font-bold">{mentor.campaignsLaunched} launched</div>
                                            </div>
                                            <div className="bg-[#062117] rounded-lg px-3 py-2 border border-[#0098cc]/20">
                                                <div className="text-[#0098cc] text-xs font-semibold mb-1 flex items-center gap-1">
                                                ...
                                                <div className="text-white text-sm font-bold">{mentor.reachImpact}</div>
                                            </div>
                                        </div>
...
export default MarketingMentorDiscovery;