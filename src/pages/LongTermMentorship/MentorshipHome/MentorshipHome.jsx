...
//               This mentor hasn't set up any subscription plans yet.
//             </p>
//           </div>
//         ) : (
//           <>
...
//           <button
//             onClick={() => onViewProfile(mentor)}   // ← add onClick
...
//                 onViewProfile={(mentor) => navigate(`/mentor-profile/${mentor._id}`)}  // ← add this
...
// MentorshipHome.jsx
import { useState, useEffect } from "react";
import { MapPin, Star, Users, Award, TrendingUp, X, ChevronDown, ClipboardList, ChevronUp, CheckCircle } from "lucide-react";
import { motion, AnimatePresence } from "framer-motion";
import {
  useGetLtmAllMentorsQuery,
  useSearchMentorMutation,
