...
import { useGetEngineeringMentorsQuery } from "./EngineeringMentorapislice";
...
const EngineerMentors = () => {
    ...
    const { data: mentorsData, isLoading, isError, error, refetch } = useGetEngineeringMentorsQuery(getFilters());
