    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-4 md:p-6 lg:p-8">
                ...
                {bookings.map((booking) => (
                  ...
                  >
                    ...
                    <div className="p-4 space-y-3">
                      ...
                      <button
                        onClick={() => handleViewDetails(booking)}
                        className="w-full mt-3 flex items-center justify-center gap-2 bg-[#2563eb] hover:bg-[#1d4ed8] text-white px-4 py-2.5 rounded-lg font-semibold text-sm transition-colors"
                      >
                        <Eye className="w-4 h-4" />
                        View Details
                      </button>
      ...
      {showDetailsModal && selectedBooking && (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4 overflow-y-auto">
          <div className="bg-white rounded-2xl max-w-4xl w-full my-8">
            {/* Modal Header */}
            <div className="bg-[#2563eb] p-6 text-white rounded-t-2xl">
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-4">
                  <div className="w-16 h-16 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center">
                    <span className="text-2xl font-bold">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-start gap-3">
                      <Tag className="w-5 h-5 text-[#2563eb] mt-0.5 flex-shrink-0" />
                      <div>
                        <p className="text-xs text-gray-500 mb-0.5">Session Type</p>
                        <p className="font-semibold text-gray-900">{selectedBooking.sessionType}</p>
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-sm text-[#2563eb] hover:text-[#1d4ed8] font-medium hover:underline break-all"
                          >
                            Join Meeting →
                          </a>
                        </div>
                  ...
                  <div className="flex flex-wrap gap-3">
                    {selectedBooking.meetingLink && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-2 bg-[#2563eb] hover:bg-[#1d4ed8] text-white px-6 py-3 rounded-lg font-semibold transition-colors"
                      >
                        <Video className="w-5 h-5" />
                        Join Meeting
                      </a>
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 bg-white border-2 border-[#2563eb] text-[#2563eb] hover:bg-[#2563eb] hover:text-white px-6 py-3 rounded-lg font-semibold transition-colors"
                    >
                      <RefreshCw className="w-5 h-5" />
                      Reschedule
                    </button>
          ...
          <div className="bg-white rounded-2xl max-w-md w-full p-6">
            ...
            <div className="flex gap-3">
              ...
              <button
                onClick={handleCancelBooking}
                disabled={isCancelling}
                className="flex-1 bg-[#2563eb] hover:bg-[#1d4ed8] text-white px-6 py-3 rounded-lg font-semibold transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isCancelling ? "Cancelling..." : "Cancel Booking"}
              </button>
            </div>
