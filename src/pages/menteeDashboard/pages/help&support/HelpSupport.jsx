                ...
                <div className="bg-white rounded-lg shadow-sm overflow-hidden">
                    <div className="overflow-x-auto">
                        <table className="w-full">
                            <thead className="bg-gray-50 border-b border-gray-200">
                                <tr>
                                    <th className="px-3 lg:px-4 xl:px-6 py-3 xl:py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Ticket ID</th>
                                    <th className="px-3 lg:px-4 xl:px-6 py-3 xl:py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Subject</th>
                                    <th className="px-3 lg:px-4 xl:px-6 py-3 xl:py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Category</th>
                                    <th className="px-3 lg:px-4 xl:px-6 py-3 xl:py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Priority</th>
                                    <th className="px-3 lg:px-4 xl:px-6 py-3 xl:py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Status</th>
                                    <th className="px-3 lg:px-4 xl:px-6 py-3 xl:py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Created Date</th>
                                    <th className="px-3 lg:px-4 xl:px-6 py-3 xl:py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Response</th>
                                    <th className="px-3 lg:px-4 xl:px-6 py-3 xl:py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Action</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-gray-200">
                                {filteredTickets.length === 0 ? (
                                    ...
                                    filteredTickets.map((ticket) => (
                                        <tr key={ticket.ticketId} className="hover:bg-gray-50 transition-colors">
                                            <td className="px-3 lg:px-4 xl:px-6 py-4 whitespace-nowrap">
                                                <span className="text-xs lg:text-sm font-medium text-[#ea580c]">{ticket.ticketId}</span>
                                            </td>
                                            <td className="px-3 lg:px-4 xl:px-6 py-4">
                                                <p className="text-xs lg:text-sm font-medium text-gray-900 line-clamp-2 max-w-xs">{ticket.subject}</p>
                                            </td>
                                            <td className="px-3 lg:px-4 xl:px-6 py-4 whitespace-nowrap">
                                                <span className="text-xs lg:text-sm text-gray-600">{ticket.category}</span>
                                            </td>
                                            <td className="px-3 lg:px-4 xl:px-6 py-4 whitespace-nowrap">
                                                {getPriorityBadge(ticket.priority)}
                                            </td>
                                            ...
                                            <td className="px-3 lg:px-4 xl:px-6 py-4 whitespace-nowrap text-xs lg:text-sm text-gray-600">
                                                {new Date(ticket.createdAt).toLocaleDateString()}
                                            </td>
                                            <td className="px-3 lg:px-4 xl:px-6 py-4">
                                                {ticket.response ? (
                                                    <div className="max-w-xs">
                                                        <p className="text-xs lg:text-sm text-gray-900 line-clamp-2">{ticket.response}</p>
                                                        {ticket.respondedAt && (
                                                            <p className="text-xs text-gray-500 mt-1">{new Date(ticket.respondedAt).toLocaleDateString()}</p>
                                                        )}
                                                    </div>
                                                ) : (
                                                    <span className="text-xs lg:text-sm text-gray-400 italic">No response yet</span>
                                                )}
                                            </td>
                                            <td className="px-3 lg:px-4 xl:px-6 py-4 whitespace-nowrap">
                                                {ticket.response && ticket.status !== 'resolved' && ticket.status !== 'closed' ? (
                                                    <button
                                                        ...
                                                        className="text-xs lg:text-sm bg-[#ea580c] hover:bg-[#c2410c] text-white px-3 py-1.5 rounded-lg transition-colors flex items-center gap-1 whitespace-nowrap"
                                                    >
                        ...
                        <form onSubmit={handleFeedbackSubmit} className="p-4 sm:p-6">
                            ...
                            <div className="flex flex-col sm:flex-row justify-end gap-3 mt-6 pt-4 border-t border-gray-200">
                                ...
                                <button
                                    ...
                                    className="w-full sm:w-auto px-4 py-2.5 bg-[#ea580c] text-white rounded-lg hover:bg-[#c2410c] transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-sm"
                                >
                                    {isUpdating ? (
                                        <>
                                            <div className="animate-spin rounded-full h-4 w-4 border-2 border-white border-t-transparent"></div>
