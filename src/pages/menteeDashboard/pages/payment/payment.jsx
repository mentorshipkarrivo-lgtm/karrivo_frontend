...
//   useEffect(() => {
//     if (!bookingId || !mentorId || !paymentAmount) {
//       toast.error("Invalid payment session. Please book a session first.");
//       navigate("/mentors");
//     }
//   }, [bookingId, mentorId, paymentAmount, navigate]);
...
// import { CheckCircle, CreditCard, Calendar, Clock, User, Mail, Phone, AlertCircle } from "lucide-react";
// import { useCreateBookingMutation } from "../../../home/mentorsection/mentorsectionapislice";
...
//   const mentorEmail = location.state?.mentorEmail;
...
//       navigate("/");
//     }
//   }, [bookingDetails, mentorId, navigate]);
...
//       console.log("Creating booking after payment:", payload);
...
//       // Redirect to mentee dashboard after 3 seconds
//       setTimeout(() => {
...
//             Your session with <span className="font-semibold text-gray-800">{mentorName}</span> has been booked successfully.
//           </p>
...
//           <div className="bg-gradient-to-r from-[#0098cc] to-[#062117] p-6 text-white">
//             <h1 className="text-3xl font-bold">Complete Your Payment</h1>
//             <p className="text-blue-100 mt-2">Secure checkout for your mentorship session</p>
//           </div>
...
//                     className="w-full border border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#0098cc]"
//                     required
//                   />
//                 </div>
...
//                 <button
//                   type="submit"
//                   disabled={processingPayment || isCreatingBooking}
//                   className="w-full bg-gradient-to-r from-[#0098cc] to-[#062117] text-white font-bold py-4 rounded-lg hover:opacity-90 transition disabled:opacity-50 disabled:cursor-not-allowed"
//                 >
//                   {processingPayment || isCreatingBooking ? (
...
//                   <p className="text-xl font-bold text-gray-800">{mentorName}</p>
//                 </div>
...
//                       <p className="font-semibold text-gray-800">
//                         {bookingDetails.time} ({bookingDetails.duration} minutes)
//                       </p>
//                     </div>
//                   </div>
...
//                       <p className="font-semibold text-gray-800">{bookingDetails.topic}</p>
//                     </div>
//                   </div>
//                 </div>
...
//                   <strong>Note:</strong> You will receive a confirmation email with meeting details after payment.
//                 </p>
//               </div>
//             </div>
//           </div>
