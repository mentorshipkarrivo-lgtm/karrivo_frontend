...
// //                  hover:border-blue-300 transition-all duration-200 font-[DM_Sans,sans-serif]
// //                  w-full sm:w-[220px] lg:w-[240px] flex-shrink-0"
// //     >
// //       <div className="relative w-full h-[140px] bg-slate-100 overflow-hidden">
// //         {mentor.profilePhoto || mentor.profileImage ? (
// //           <img src={mentor.profilePhoto || mentor.profileImage} alt={mentor.fullName} className="w-full h-full object-cover object-top" />
// //         ) : (
...
// //       </div>
// //       <div className="p-3">
// //         <h3 className="font-semibold text-slate-900 text-[13px] leading-tight truncate">{mentor.fullName || "Unknown Mentor"}</h3>
// //         <p className="text-xs text-slate-500 mt-0.5 truncate">
// //           {mentor.currentRole || "Mentor"}{mentor.yearsOfExperience ? ` · ${mentor.yearsOfExperience}+ yrs` : ""}
// //         </p>
// //         {mentor.companyName && (
...
// //           className="mt-3 w-full py-1.5 rounded-lg bg-slate-900 text-white text-xs font-semibold
// //                      hover:bg-[#0098cc] active:scale-[0.98] transition-all duration-150"
// //         >
// //           View Profile
// //         </button>
// //       </div>
...
//                  flex items-stretch w-full h-[140px] sm:h-[150px]"
//     >
//       {/* LEFT: Image Section */}
//       <div className="relative w-[140px] sm:w-[150px] h-full bg-gradient-to-br from-slate-100 to-slate-200 flex-shrink-0 overflow-hidden">
//         {hasImage ? (
//           <>
//             <img
...
//           <Star className="w-3 h-3 fill-yellow-400 text-yellow-400" />
//           <span className="text-[10px] font-bold text-slate-800">{mentor.rating ? Number(mentor.rating).toFixed(1) : "5.0"}</span>
//         </div>
...
//               <span className="text-[9px] text-slate-400 px-1.5 py-0.5">+{mentor.guidanceAreas.length - 2}</span>
//             )}
//           </div>
//         )}
...
//         <button
//           onClick={() => onViewProfile(mentor)}
//           className="mt-2 w-full py-1.5 rounded-lg font-semibold text-xs text-white
//                      transition-all duration-150 active:scale-[0.97] shadow-sm"
//           style={{ backgroundColor: '#1a1a2e' }}
//           onMouseEnter={(e) => e.target.style.backgroundColor = '#0098cc'}
...
// //                  hover:bg-slate-50/50 transition-colors duration-150 font-[DM_Sans,sans-serif] overflow-hidden"
// //     >
// //       {/* Date column */}
...
// //       {/* Right: mentor image — hidden on very small screens to avoid cramping */}
...
// //             <span className="text-xl font-bold text-white/80 select-none">{getMentorInitials(booking)}</span>
// //           </div>
// //         )}
...
// //       initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.25 }}
// //       className="group relative flex items-stretch border-b border-slate-100 last:border-b-0
// //                  hover:bg-white transition-colors duration-150 font-[DM_Sans,sans-serif] overflow-hidden bg-white"
// //     >
// //       {/* Date column */}
// //       <div className="flex-shrink-0 w-14 sm:w-16 flex flex-col items-center justify-center py-4 border-r border-slate-100 bg-white">
// //         <span className="text-[9px] font-bold uppercase tracking-widest" style={{ color: '#0098cc' }}>
// //           {MONTH_SHORT[new Date(booking.sessionDate).getMonth()]}
// //         </span>
// //         <span className="text-xl sm:text-2xl font-bold text-slate-900 leading-tight">
// //           {new Date(booking.sessionDate).getDate()}
...
// //         <p className="text-[10px] font-semibold uppercase tracking-wide mb-0.5" style={{ color: '#0098cc' }}>
// //           {booking.sessionType || "1:1 Session"}
// //         </p>
// //         <h3 className="text-sm font-semibold text-slate-900 truncate">{booking.mentorName}</h3>
// //         <p className="text-xs text-slate-400 mt-0.5 truncate">{booking.topic || mentorSubtitle || "Mentorship Session"}</p>
...
// //             onClick={() => onOpenPanel(booking, "details")}
// //             className="flex items-center gap-1 px-2.5 py-1.5 rounded-md text-[11px] font-semibold
// //                        text-white transition-all active:scale-[0.97] hover:opacity-90"
...
// //               style={{ color: '#0098cc', borderColor: '#0098cc', backgroundColor: 'white' }}>
// //               <Video className="w-3 h-3" /> Join
// //             </a>
// //           )}
// //         </div>
...
//       className={`group relative flex items-stretch border-b border-slate-100 last:border-b-0
//       ${booking.isExpired ? "opacity-60 grayscale pointer-events-none cursor-not-allowed border-l-4 border-red-400" : "hover:bg-white"}
...
//           {booking.topic || mentorSubtitle || "Mentorship Session"}
//         </p>
...
//           {/* ❌ Disabled View Details if expired */}
//           <button
...
//             style={{ backgroundColor: booking.isExpired ? "#94a3b8" : "#0098cc" }}
//           >
//             <Eye className="w-3 h-3" /> View Details
//           </button>
...
//                 style={{
//                   color: canJoin ? '#0098cc' : '#94a3b8',
//                   borderColor: canJoin ? '#0098cc' : '#cbd5e1',
...
// /* ═══════════════════════════════════════════════════════════════════════════
//    RIGHT SIDEBAR WIDGETS — extracted so they render both inline (mobile) and
//    sticky (desktop) without duplication
//    ═══════════════════════════════════════════════════════════════════════════ */
...
//               style={{ color: "#0098cc", backgroundColor: "rgba(0,152,204,0.08)" }}
//             >
//               Bookings
//             </span>
//           </h1>
...
//         {/* ── MOBILE / TABLET: sidebar widgets appear at the TOP as a banner row ── */}
...
//             {/* Mentor card row */}
//             {!mentorsLoading && !mentorsError && filtered.length > 0 && (
//               <div className="flex gap-3 pb-3 overflow-x-auto sm:overflow-x-auto lg:overflow-x-visible lg:flex-wrap snap-x snap-mandatory -mx-4 px-4 sm:-mx-6 sm:px-6 lg:mx-0 lg:px-0">
//                 {filtered.map((mentor, i) => (
//                   <div key={mentor._id || i} className="snap-start flex-shrink-0 w-[180px] sm:w-[210px] lg:w-auto lg:flex-shrink">
//                     <MentorCard mentor={mentor} index={i} onViewProfile={handleViewProfile} />
//                   </div>
//                 ))}
//               </div>
//             )}
...
//                         style={{ color: "#0098cc" }}
//                         onMouseEnter={e => e.currentTarget.style.color = "#007aad"}
...
//                       target="_blank"
//                       rel="noopener noreferrer"
//                       className="flex items-center justify-center gap-2 w-full py-2.5 rounded-lg font-semibold text-sm text-white transition-colors duration-150"
//                       style={{ backgroundColor: "#1a1a2e" }}
//                       onMouseEnter={e => e.currentTarget.style.backgroundColor = "#0098cc"}
...
//                       className="w-full py-2.5 rounded-lg font-semibold text-sm transition-colors duration-150 border"
//                       style={{
...
//                         e.currentTarget.style.borderColor = "#0098cc";
//                       }}
//                       onMouseLeave={e => {
...
//                       }}
//                       onMouseEnter={e => {
//                         e.currentTarget.style.backgroundColor = "rgba(0,152,204,0.06)";
//                         e.currentTarget.style.borderColor = "#0098cc";
...
//                     rows={5}
//                     className="w-full border border-slate-200 rounded-xl px-4 py-3 text-sm resize-none bg-white transition-all placeholder:text-slate-400 outline-none"
//                     style={{ focusRingColor: "#0098cc" }}
...
//                     className="flex-1 py-2.5 rounded-lg font-medium text-sm transition-colors duration-150 border"
//                     style={{
//                       backgroundColor: "white",
//                       color: "#1a1a2e",
//                       borderColor: "#e2e8f0",
...
//                     className="flex-1 py-2.5 rounded-lg font-semibold text-sm text-white transition-colors duration-150 disabled:opacity-50 disabled:cursor-not-allowed"
//                     style={{ backgroundColor: "#1a1a2e" }}
//                     onMouseEnter={e => { if (!isCancelling) e.currentTarget.style.backgroundColor = "#0098cc"; }}
//                     onMouseLeave={e => { if (!isCancelling) e.currentTarget.style.backgroundColor = "#1a1a2e"; }}
//                   >
//                     {isCancelling
