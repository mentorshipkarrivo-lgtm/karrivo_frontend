...
// //     // Multi-select: array of selected domains (max 3)
...
// //         setSearchText("");
// //         // Keep dropdown open if still under max
...
// //         navigate.push(`/explore-mentors?${params.toString()}`);
// //     };
...
// //     return (
// //         <div style={{ background: colors.white, fontFamily: "Cambria, serif", minHeight: "100vh", padding: "40px 28px" }}>
// //             <style>{`
...
// //                         <h1 style={{ fontSize: "32px", fontWeight: 900, color: colors.textDark, marginBottom: "6px", lineHeight: "1.2" }}>
// //                             Find Your Ideal Mentor
// //                         </h1>
// //                         <h2 style={{ fontSize: "20px", fontWeight: 700, color: colors.primary }}>
...
// //                     {/* I'm a */}
// //                     <div style={{ marginBottom: "30px" }}>
// //                         <p style={{ fontSize: "13px", fontWeight: 900, color: colors.textDark, marginBottom: "14px", textTransform: "uppercase", letterSpacing: "0.8px" }}>
// //                             I'm a
// //                         </p>
...
// //                             <p style={{ fontSize: "13px", fontWeight: 900, color: colors.textDark, textTransform: "uppercase", letterSpacing: "0.8px" }}>
// //                                 Looking for mentorship in
// //                             </p>
// //                             <span style={{
...
// //                                 {!atMax && (
// //                                     <div style={{ display: "flex", alignItems: "center", flex: 1, minWidth: "120px", gap: "6px" }}>
...
// //                                 {/* Max reached hint */}
// //                                 {atMax && (
// //                                     <span style={{ fontSize: "11px", color: colors.primary, fontWeight: 600, fontFamily: "Cambria, serif", flex: 1 }}>
...
// //                                         <div style={{ padding: "12px 14px", fontSize: "12px", color: colors.mutedText, fontFamily: "Cambria, serif" }}>
// //                                             No results found
// //                                         </div>
// //                                     )}
...
// //                         {/* Quick filter tags — only show domains not yet selected, max 4 */}
// //                         <div style={{ display: "flex", flexWrap: "wrap", gap: "8px" }}>
// //                             {domains.slice(0, 5).filter(d => !selectedDomains.includes(d)).slice(0, 4).map((domain) => (
// //                                 <button
// //                                     key={domain}
// //                                     className="tag-btn"
// //                                     disabled={atMax}
...
// //                         style={{
// //                             width: "100%", padding: "15px", background: "#1a1a2e",
...
//         console.log("🎯 Navigating with params:", queryString);

//         // Navigate with query string
//         navigate(`/explore-mentors${queryString ? `?${queryString}` : ""}`);
//     };
...
//                         {/* Quick filter tags — responsive layout */}
//                         <div style={{
