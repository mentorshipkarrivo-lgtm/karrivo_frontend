...
//     return (
//         <div style={{ background: colors.white, fontFamily: FONT, minHeight: "90vh", padding: isMobile ? "24px 16px" : isTablet ? "32px 24px" : "40px 28px" }}>
//             <style>{`
...
function ScrollColumn({ mentors, direction = "up", height = 580 }) {
    const doubled = [...mentors, ...mentors];
    const animName = direction === "up" ? "scrollUp" : "scrollDown";
    const duration = mentors.length * 5;
    return (
        <div style={{ overflow: "hidden", height: `${height}px`, position: "relative" }}>
            <div style={{
                display: "flex", flexDirection: "column",
                animation: `${animName} ${duration}s linear infinite`,
                willChange: "transform",
...
const MentorDiscoveryUI = () => {
    ...
    // Breakpoints — tuned so the layout holds up from small phones through ultra-wide monitors
    ...
    // Right-side scrolling columns size themselves to the viewport height so they
    // never overflow on short laptop screens, and don't look tiny on tall monitors.
    const rightColHeight = Math.round(Math.max(420, Math.min(640, windowHeight - 200)));
    ...
    return (
        <div style={{
            ...
            padding: isSmallMobile ? "20px 14px" : isMobile ? "24px 16px" : isTablet ? "32px 24px" : "40px 28px",
            ...
            <style>{`
                ...
                * { box-sizing: border-box; margin: 0; padding: 0; font-family: Cambria !important; }
                ...
                @media (max-width:419px) {
                    .cat-btn { padding: 14px 10px !important; }
                }
            `}</style>

            <div style={{
                display: isDesktop ? "grid" : "flex",
                gridTemplateColumns: isDesktop ? (isLargeDesktop ? "48% 44%" : "50% 42%") : undefined,
                flexDirection: isDesktop ? undefined : "column",
                gap: isDesktop ? (isLargeDesktop ? "120px" : "100px") : isSmallMobile ? "24px" : isMobile ? "32px" : "48px",
                maxWidth: isLargeDesktop ? "1440px" : isDesktop ? "1280px" : isTablet ? "900px" : "100%",
                width: "100%",
                margin: "0 auto",
                alignItems: isDesktop ? "center" : "stretch",
            }}>
                ...
                <div style={{ position: isDesktop ? "sticky" : "relative", top: isDesktop ? "40px" : undefined }}>
                    ...
                    <div style={{ marginBottom: isSmallMobile ? "18px" : isMobile ? "24px" : "30px" }}>
                        <h1 style={{ fontSize: isSmallMobile ? "21px" : isMobile ? "24px" : isTablet ? "28px" : "32px", fontWeight: 900, color: colors.textDark, marginBottom: "6px", lineHeight: "1.2", fontFamily: FONT }}>
                            Find Your Ideal Mentor
                        </h1>
                        <h2 style={{ fontSize: isSmallMobile ? "14px" : isMobile ? "16px" : isTablet ? "18px" : "20px", fontWeight: 700, color: colors.primary, fontFamily: FONT }}>
                            From 600+ Top Experienced Mentors
                        </h2>
                    </div>
                ...
                {isDesktop && (
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}>
                        <div className="scroll-wrap"><ScrollColumn mentors={col1} direction="up" height={rightColHeight} /></div>
                        <div className="scroll-wrap"><ScrollColumn mentors={col2} direction="down" height={rightColHeight} /></div>
                    </div>
                )}
                ...
                {!isDesktop && (
                    <div style={{ marginTop: "8px" }}>
                        <h3 style={{ fontSize: isSmallMobile ? "15px" : isMobile ? "16px" : "18px", fontWeight: 700, color: colors.textDark, marginBottom: "16px", fontFamily: FONT }}>
                            Popular Mentors
                        </h3>
                        <MentorGrid
                            mentors={previewMentors.slice(0, isSmallMobile ? 2 : isMobile ? 4 : 6)}
                            columns={isSmallMobile ? 1 : isMobile ? 2 : 3}
                        />
                    </div>
                )}
            </div>
