...
//                             <h2 style={{ fontWeight: 800, fontSize: "20px", color: "#374151", margin: 0 }}>{mentor.fullName || "Mentor"}</h2>
...
//                         <span style={{ fontSize: "30px", fontWeight: 800, color: "#37415c", letterSpacing: "-1px" }}>{fmtINR(hourlyRate)}</span>
...
//                         style={{ width: "100%", padding: "11px", background: "white", color: "#ffffff", border: "1.5px solid #d1d5db", backgroundColor : "#2737ff",  borderRadius: "8px", fontWeight: 600, fontSize: "14px", cursor: "pointer", fontFamily: FONT, transition: "all .15s" }}
...
//                             style={{ width: "100%", padding: "12px", background: "#2578f0", color: "white", border: "none", borderRadius: "8px", fontWeight: 700, fontSize: "14px", cursor: "pointer", fontFamily: FONT, transition: "background .15s" }}
//                             onMouseEnter={(e) => (e.currentTarget.style.background = "#2578f0")}
//                             onMouseLeave={(e) => (e.currentTarget.style.background = "#2578f0")}
//                         >
//                             Book a Free Trial
//                         </button>
//                         {nextAvail && (
...
//                 <h3 style={{ fontWeight: 700, fontSize: "16px", color: "#37415c", margin: 0 }}>Filter By</h3>
...
//             <p style={{ fontWeight: 600, fontSize: "14px", color: "#37415c", margin: "0 0 10px" }}>Domain</p>
...
//             <p style={{ fontWeight: 600, fontSize: "14px", color: "#37415c", margin: "0 0 10px" }}>Offering Mentorship For</p>
...
//             <p style={{ fontWeight: 600, fontSize: "14px", color: "#37415c", margin: "0 0 10px" }}>Pricing</p>
...
//                 style={{ marginTop: "20px", width: "100%", padding: "11px", background: isSearching ? "#93c5fd" : "#2578f0", color: "white", border: "none", borderRadius: "8px", fontWeight: 600, fontSize: "13px", cursor: isSearching ? "not-allowed" : "pointer", fontFamily: FONT }}
//             >
