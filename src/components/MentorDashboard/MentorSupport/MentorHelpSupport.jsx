...
export default function MentorHelpSupport() {
  ...
  const inputClass =
    "w-full border border-gray-300 rounded-xl px-4 py-3 text-sm bg-white text-gray-600 outline-none focus:ring-2 focus:ring-[#0098cc]";

  const buttonPrimary =
    "bg-[#1a1a2e] text-white px-5 py-3 rounded-xl text-sm font-semibold hover:opacity-90 transition";

  const buttonSecondary =
    "border border-gray-300 text-gray-600 px-5 py-3 rounded-xl text-sm font-medium bg-white hover:border-[#0098cc] transition";
    ...
    <div className="min-h-screen bg-white p-6 text-gray-700">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold text-[#1a1a2e] flex items-center gap-2">
              <TicketCheck size={26} className="text-[#0098cc]" />
              Help & Support
            </h1>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200 bg-gray-50">
                  {["Ticket ID", "Subject", "Category", "Priority", "Status", "Created"].map((item) => (
                    <th
                      key={item}
              ...
              <tbody>
                {filteredTickets.length === 0 ? (
                  ...
                  filteredTickets.map((ticket) => (
                    ...
                    >
                      <td className="px-6 py-5 text-sm font-medium text-[#0098cc]">
                        {ticket.ticketId}
                      </td>

                      <td className="px-6 py-5 text-sm text-[#1a1a2e] font-medium">
                        {ticket.subject}
                      </td>
                      ...
                      <td className="px-6 py-5">
                        <span className="px-3 py-1 rounded-full bg-[#0098cc]/10 text-[#0098cc] text-sm">
                          {ticket.status}
                        </span>
                      </td>
