...
//     Calendar, User, Video, RefreshCw, Loader2, TriangleAlert,
//     CalendarX, Clock, BadgeCheck, CircleDot, CircleX, CircleCheck,
//     X, Eye, Mail, Phone, Link2, Users, CreditCard, Timer, Tag,
//     MessageSquare, Shield, Copy, Check, ExternalLink
// } from 'lucide-react';
// import { useGetMentorSessionsQuery } from '../MentorDashboardapislice';
// import Loader from '../../../global/Loader';
...
//     };
//     return (
//         <span className={`inline-flex items-center px-2.5 py-1 rounded-md text-xs font-medium capitalize ${map[paymentStatus] || 'bg-white/5 text-white/40 ring-1 ring-white/10'}`}>
//             {paymentStatus.charAt(0).toUpperCase() + paymentStatus.slice(1)}
//         </span>
//     );
// };
...
//         >
//             <div
//                 className="w-full max-w-lg bg-[#062117] border border-white/10 rounded-2xl overflow-hidden flex flex-col max-h-[90vh] shadow-2xl"
//                 onClick={e => e.stopPropagation()}
//             >
//                 {/* ── Modal header ── */}
//                 <div className="px-5 py-4 flex items-center justify-between shrink-0 border-b border-white/10">
//                     <div className="flex items-center gap-3 min-w-0">
//                         <div className="w-10 h-10 rounded-full bg-[#0098cc]/10 flex items-center justify-center shrink-0">
...
//                     <button
//                         onClick={onClose}
//                         className="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center text-white/40 hover:bg-white/10 hover:text-white/60 transition-all"
//                     >
//                         <X size={14} />
//                     </button>
//                 </div>
...
//                     {session.description && (
//                         <DetailRow icon={MessageSquare} label="Description" value={session.description} />
//                     )}
...
//                             <DetailRow icon={Link2} label="Start URL (Host)" value={session.zoomMeeting.startUrl} copyable isLink />
//                         </>
//                     )}
...
//                 {/* ── Modal footer ── */}
//                 <div className="px-5 py-3 shrink-0 flex gap-2 border-t border-white/10 bg-[#031610]/60">
//                     {session.meetingLink ? (
//                         <a
...
//                         </a>
//                     ) : (
//                         <div className="flex-1 flex items-center justify-center gap-2 bg-white/5 text-white/30 py-2.5 rounded-xl text-sm font-medium">
...
//                         key={f}
//                         onClick={() => setFilter(f)}
//                         className={`px-3 sm:px-4 py-1.5 rounded-lg text-xs sm:text-sm font-medium transition-all capitalize ${filter === f
//                             ? 'bg-[#0098cc] text-white'
//                             : 'bg-[#062117] border border-white/10 text-white/50 hover:text-white hover:border-white/20'
//                             }`}
//                     >
...
//                                                     <span className="text-violet-400 text-xs font-medium">Free</span>
//                                                 ) : (
//                                                     <span className="text-white text-sm font-medium">{session.price}</span>
//                                                 )}
//                                             </td>
