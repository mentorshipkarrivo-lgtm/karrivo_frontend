                            ...
                            {modalTab === "experience" && (
                                <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
                                    ...
                                    <div className="em-grid-main">
                                        ...
                                        <div><span style={lbl}>Current Position</span><input style={inp()} value={formData.currentRole || ""} onChange={(e) => set("currentPosition", e.target.value)} placeholder="e.g. Principal Engineer" /></div>
