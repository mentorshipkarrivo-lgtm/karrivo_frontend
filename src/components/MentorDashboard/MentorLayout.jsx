...
//     { id: "subscriptions", label: "Subscriptions & Sessions", icon: Users, route: "/mentor/dashboard/my-mentee-sessions" },
...
//                             {!collapsed && (
//                                 <span style={{ flex: 1, textAlign: "left", fontFamily: F }}>{item.label}</span>
//                             )}
//                         </button>
//                     );
//                 })}
...
//                     const Icon = item.icon;
//                     return (
//                         <div key={item.title} style={{ display: "flex", alignItems: "center", gap: 10, padding: "11px 12px", border: `1px solid ${T.border}`, borderRadius: 10, marginBottom: 8, cursor: "pointer", transition: "0.2s" }}>
...
// // ── Center Content ─────────────────────────────────────────────────────────────
// const CenterContent = ({ children, isHome, onEditProfileOpen, onSetEditTab, mentor }) => {
//     const navigate = useNavigate();
...
//     const profileStrengthColor = progressPct < 30 ? "#E24B4A" : progressPct < 70 ? "#BA7517" : "#3B6D11";
...
//                 <div>
//                     <p style={{ fontFamily: F, fontSize: 12, color: T.textLight, margin: "0 0 5px" }}>Welcome back 👋</p>
//                     <p style={{ fontFamily: F, fontSize: 22, fontWeight: 600, color: T.textDark, margin: "0 0 4px", lineHeight: 1.2 }}>{mentorName}</p>
//                     <p style={{ fontFamily: F, fontSize: 13, color: T.textLight, margin: 0 }}>Let's get your profile ready to attract mentees.</p>
//                 </div>
//                 <div style={{
//                     width: 46, height: 46, borderRadius: "50%", flexShrink: 0,
//                     background: "#EEEDFE", border: "1.5px solid #CECBF6",
//                     display: "flex", alignItems: "center", justifyContent: "center",
//                     fontFamily: F, fontSize: 15, fontWeight: 600, color: "#3C3489",
//                 }}>
//                     {mentorInitials}
//                 </div>
//             </div>
...
//                 <p style={{ fontFamily: F, fontSize: 15, fontWeight: 600, color: T.textDark, margin: "0 0 4px" }}>
//                     Finish setting up your mentor profile
//                 </p>
//                 <p style={{ fontFamily: F, fontSize: 12, color: T.textLight, margin: "0 0 16px" }}>
//                     Kickstart mentoring with a profile you create and love. 💙
//                 </p>

//                 {/* progress bar row */}
//                 {/* <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 10 }}>
//                     <span style={{ fontFamily: F, fontSize: 13, fontWeight: 600, color: T.textDark }}>{progressPct}% complete</span>
//                     <span style={{ fontFamily: F, fontSize: 12, fontWeight: 500, color: "#A32D2D" }}>({completedCount}/{totalCount}) Completed</span>
//                 </div>
//                 <div style={{ height: 7, borderRadius: 99, background: T.surface, overflow: "hidden" }}>
//                     <div style={{ width: `${progressPct}%`, height: "100%", borderRadius: 99, background: "#E24B4A", transition: "width .4s ease" }} />
//                 </div> */}

//                 {/* stat mini-strip */}
//                 {/* <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 10, marginTop: 18 }}>
//                     {[
//                         { label: "Steps done",      value: `${completedCount}`, sub: `/ ${totalCount}` },
//                         { label: "Profile strength", value: profileStrength,     valueColor: profileStrengthColor },
//                         { label: "Est. time left",   value: `~${estMinutes}`,    sub: "min" },
//                     ].map((stat, i) => (
//                         <div key={i} style={{ background: T.surface, borderRadius: 10, padding: "12px 14px" }}>
//                             <p style={{ fontFamily: F, fontSize: 11, color: T.textLight, margin: "0 0 4px" }}>{stat.label}</p>
//                             <p style={{ fontFamily: F, fontSize: 18, fontWeight: 600, color: stat.valueColor || T.textDark, margin: 0 }}>
//                                 {stat.value}
//                                 {stat.sub && <span style={{ fontSize: 13, fontWeight: 400, color: T.textLight, marginLeft: 3 }}>{stat.sub}</span>}
//                             </p>
//                         </div>
//                     ))}
//                 </div> */}
...
//                 {/* card header */}
//                 <div style={{ display: "flex", alignItems: "center", gap: 14, padding: "16px 22px", borderBottom: `1px solid ${T.border}` }}>
//                     <div style={{ ...iconBox("#EEEDFE") }}>
//                         <Users size={18} color="#3C3489" />
//                     </div>
//                     <div style={{ flex: 1 }}>
//                         <p style={{ fontFamily: F, fontSize: 13, fontWeight: 600, color: T.textDark, margin: "0 0 2px" }}>Setting up your long term mentorship</p>
...
//                                     <StepIcon size={16} color={step.locked ? T.textLight : step.done ? "#27500A" : "#3C3489"} />
//                                 </div>
//                                 <div style={{ flex: 1 }}>
...
//                                         </p>
//                                         {step.done && (
//                                             <span style={{ fontFamily: F, fontSize: 10, fontWeight: 600, background: "#EAF3DE", color: "#27500A", padding: "2px 9px", borderRadius: 99 }}>
//                                                 Done
//                                             </span>
//                                         )}
//                                     </div>
