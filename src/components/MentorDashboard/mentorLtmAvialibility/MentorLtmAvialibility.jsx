...
/* ══════════════════════════════════════════════════
   SHARED CLASS TOKENS (matches MentorHelpSupport / Myearnings)
══════════════════════════════════════════════════ */
const inputCls =
...
const Card = ({ children, className = "" }) => (
  <div className={`bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden mb-4 ${className}`}>
    {children}
  </div>
);
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <h1 className="text-2xl font-bold text-[#1a1a2e] flex items-center gap-2">
                <Calendar size={22} className="text-[#0098cc]" />
                Availability
              </h1>
          ...
          <div className="flex gap-1">
            {[
              ...
              <button
                key={key}
                onClick={() => setTab(key)}
                className={`flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl text-xs font-semibold transition border ${tab === key
                  ? "bg-[#0098cc]/10 border-[#0098cc]/30 text-[#0098cc]"
                  : "text-gray-400 hover:text-gray-700 border-transparent hover:bg-gray-100"
                  }`}
              >
                <Icon size={12} />
                {label}
                {key === "unavailability" && unavailRecs.length > 0 && (
                  <span className="text-[9px] bg-gray-100 border border-gray-200 px-1.5 py-0.5 rounded-full font-bold text-gray-400">
                    {unavailRecs.length}
                  </span>
                )}
              </button>
      ...
      <div className="max-w-3xl mx-auto px-5 py-6">
              ...
              <div className="anim-slide">
                <Card>
                  ...
                  <div className="p-6">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-4">
                      {ALL_DAYS.map((day) => {
                        ...
                        return (
                          <div
                            key={day}
                            className={`flex items-center gap-3 px-3 py-2.5 rounded-xl border text-xs transition ${block
                          ...
                          >
                            ...
                            {!slot?.enabled && (
                              <span className="text-gray-400 italic text-[11px]">Rest day</span>
                            )}
                          </div>
                        );
                      })}
                    ...
                    <div className="flex flex-wrap gap-x-4 gap-y-1.5 pt-3 border-t border-gray-100 text-xs text-gray-400">
                      <span>
                      ...
                      {notes && (
                        <>
                          <span className="text-gray-300">·</span>
                          <span className="italic text-gray-400">{notes}</span>
                        </>
                      )}
                    </div>
                  </div>
                ...
                <Card>
                    ...
                    right={
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          className={`text-[10px] font-semibold px-2.5 py-1 rounded-xl border transition ${allEnabled
                            ? "bg-[#1a1a2e] border-[#1a1a2e] text-white"
                            : "bg-white border-gray-300 text-gray-400 hover:border-[#0098cc] hover:text-[#0098cc]"
                            }`}
                        >
                  ...
                  <div className="p-6 space-y-2">
                    {daySlots.map((slot, i) => (
                      <div
                        key={`${slot.day}-${i}`}
                        className={`flex flex-wrap items-center gap-2.5 px-3 py-2.5 rounded-xl border transition ${slot.enabled
                          ? "border-gray-200 bg-white"
                      ...
                      >
                        ...
                        />
                        <span
                          className={`text-[10px] font-mono font-bold uppercase w-7 ${slot.enabled ? "text-[#1a1a2e]" : "text-gray-300"
                            }`}
                        >
                          {slot.day}
                        </span>
                        ...
                        {slot.enabled ? (
                          <div className="flex flex-wrap items-center gap-2 flex-1 min-w-0">
                            ...
                            <span className="text-[10px] text-gray-400 font-mono ml-auto sm:ml-0">
        ...
        {tab === "unavailability" && (
          <div className="anim-slide">
            <div className="flex items-start gap-2.5 mb-4 bg-[#0098cc]/8 border border-[#0098cc]/25 rounded-xl px-4 py-3 text-xs text-[#1a1a2e]/80">
            ...
            {!unavailRecs.length ? (
              <div className="bg-white border border-dashed border-gray-200 rounded-2xl p-14 text-center">
                <div className="w-12 h-12 rounded-xl bg-[#0098cc]/10 flex items-center justify-center mx-auto mb-3">
                  <CheckCircle2 size={22} className="text-[#0098cc]/50" />
                </div>
                ...
                {unavailRecs.map((u) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="p-4">
                        <p className="font-semibold text-gray-800 text-sm mb-2.5">
                          {u.reason}
                        </p>
                        {blocked.length > 0 && (
                        ...
                        {u.notes && (
                          <p className="text-xs text-gray-400 italic mt-2.5">{u.notes}</p>
                        )}
                      </div>
                    </div>
                  );
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center p-4 z-50 overflow-y-auto">
          <div className="bg-white rounded-3xl shadow-xl w-full max-w-md border border-gray-200 my-4 anim-fade">
            ...
            <form
              ...
              className="p-6 space-y-4 scroll-thin overflow-y-auto max-h-[70vh]"
            >
              {/* Date Range */}
              ...
              {form.unavailableFrom &&
                ...
                !hasOverlap && (
                  <div
                    className={`rounded-xl p-3 border text-xs ${affectedDays.length
                      ? "border-red-200 bg-red-50"
                        ...
                        <div className="flex flex-wrap gap-1.5">
                          {affectedDays.map((d) => {
                            ...
                            return (
                              <span
                                key={d}
                                className="bg-white border border-red-200 text-red-500 font-mono text-[11px] px-2.5 py-1 rounded-full"
                              >
                                {d}
                                {sl ? ` ${sl.from}–${sl.to}` : ""}
                              </span>
